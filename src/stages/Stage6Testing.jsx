                            ...
                            return (
                                <div className="flex flex-col gap-3">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                        ...
                                        <div className="bg-slate-50 p-2 rounded">
                                            <span className="block text-xs text-slate-400">Approved By</span>
                                            <span className="font-medium text-slate-700">{s5.finalApprovalBy}</span>
                                        </div>
                                    </div>
                            ...
                            return (
                                <div className="flex flex-col gap-3">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <span className={`px-2 py-0.5 rounded text-xs font-bold border ${s6.testingResult === 'Pass'
                                            ? 'bg-emerald-50 text-emerald-700 border-emerald-200'
                                            : 'bg-red-50 text-red-700 border-red-200'
                                            }`}>
                                            {s6.testingResult}
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                        ...
                                        <div className="bg-slate-50 p-2 rounded">
                                            <span className="block text-xs text-slate-400">Bugs</span>
                                            <span className="font-medium text-red-600">{s6.bugCount}</span>
                                        </div>
                                    </div>

                                    {s6.bugNotes && (
                                        <div className="text-sm text-slate-600 bg-slate-50 p-2 rounded border border-slate-100">
                                            <span className="block text-xs text-slate-400 mb-1">Bug Notes</span>
                                            {s6.bugNotes}
                                        </div>
                                    )}
                                    ...
                                    <div className="flex justify-between items-center pt-2 border-t border-slate-100">
                                        <span className="text-xs text-slate-500">Delay: {calculateDelay(item.requirementDate)} days</span>
                                        <span className="text-xs text-slate-400">{s6.testingDate}</span>
                                    </div>
                                </div>
                            );
                        }}
